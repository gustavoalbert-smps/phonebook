        ...
        <div class="flex justify-center min-h-[60svh] mx-auto">
            <div class="w-full rounded-lg overflow-hidden">
                <div class="p-4 text-center mb-16">
                    <div class="relative">
                        <img :src="contact.image ? contact.image : 'https://phonebook-files.s3.sa-east-1.amazonaws.com/default-avatar.svg'" alt="Profile" class="w-36 h-36 md:w-56 md:h-56 rounded-full mx-auto" />
                    </div>
